...
export function Mitarbeiter() {
  return (
    <div>
      <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Mitarbeiter</h1>
      ...
      <Card className="p-0">
        <table className="w-full text-left text-sm">
          ...
          <tbody>
            {employees.map((e) => (
              <tr key={e.id} className="border-b border-slate-50 last:border-0 dark:border-slate-800">
      ...
      <button className="mt-4 rounded-lg border border-dashed border-slate-300 px-4 py-2 text-sm font-medium text-slate-500 hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800/50">
