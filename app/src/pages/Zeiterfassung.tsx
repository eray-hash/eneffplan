        ...
        <Card className="lg:col-span-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              ...
              {clockState === 'laeuft' && (
                <>
                  <button onClick={togglePause} className="rounded-lg bg-amber-500 px-4 py-2 text-sm font-medium text-white hover:bg-amber-600">
                    Pause
                  </button>
                  <button onClick={clockOut} className="rounded-lg bg-slate-200 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-300 dark:bg-slate-700 dark:text-slate-200">
                    Ausstempeln
                  </button>
                </>
              )}
              {clockState === 'pause' && (
                <button onClick={togglePause} className="rounded-lg bg-brand-600 px-4 py-2 text-sm font-medium text-white hover:bg-brand-700">
                  Fortsetzen
                </button>
              )}
            </div>
          ...
          <div className="mt-6 border-t border-slate-100 pt-5 dark:border-slate-800">
            ...
            {clockState === 'gestoppt' ? (
              ...
              <div className="flex items-center justify-between rounded-lg border border-brand-200 bg-brand-50 px-3.5 py-3 dark:border-brand-800 dark:bg-brand-900/20">
                <div>
                  <div className="text-sm font-medium text-slate-800 dark:text-slate-100">{activeTask.title}</div>
              ...
              <div className="rounded-lg border border-dashed border-slate-200 px-3.5 py-3 dark:border-slate-700">
                <div className="text-sm font-medium text-slate-600 dark:text-slate-300">Intern (kein Projekt aktiv)</div>
